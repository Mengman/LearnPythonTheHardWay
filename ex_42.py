...
class Game(object):
    ...
    def __init__(self, start):
        self.quips = ["You died.  You kinda suck at this.", "Your mom would be proud. If she were smarter.", "Such a loser.", "I have a small puppy that's better at this."]
        self.start = start
    ...
    def gold_koi_pond(self):
        ...
        if feed_it == "feed it":
            print "The Koi jumps up, and ranther than eating the cake, eats your arm."
